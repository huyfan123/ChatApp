...
public class SendFile extends javax.swing.JFrame {
    ...
    public boolean prepare(String u, String h, int p, chatGUI m){
        this.host = h;
        this.myusername = u;
        this.port = p;
        this.main = m;
    ...
    private void initComponents() {
        ...
        btnBrowse.setBackground(new java.awt.Color(0, 132, 255));
        ...
        btnSendFile.setBackground(new java.awt.Color(0, 132, 255));
